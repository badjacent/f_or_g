  ...
  },
  {
    ...
    data: {
      ...
      debugData: makeDebugData({
        ...
        fArriveAt: BASE + min(25),
        gSwitchAt: BASE + min(8),
        gArriveAt: BASE + min(20),
      }),
    },
  },
  {
  ...
  },
  {
    ...
    data: {
      ...
      debugData: makeDebugData({
        ...
        fArriveAt: BASE + min(21),
        gSwitchAt: BASE + min(6),
        gArriveAt: BASE + min(18),
      }),
    },
  },
  {
    ...
    data: {
      ...
      debugData: makeDebugData({
        jayTs: BASE + min(3),
        hoytTs: BASE + min(5),
        fSwitchAt: BASE + min(7),
        fArriveAt: BASE + min(20),
        gSwitchAt: BASE + min(9),
        gArriveAt: BASE + min(21),
      }),
    },
  },
  {
    ...
    data: {
      ...
      debugData: makeDebugData({
        ...
        hoytTs: BASE + min(6),
        fSwitchAt: BASE + min(8),
        fArriveAt: BASE + min(19),
        gSwitchAt: BASE + min(11),
        gArriveAt: BASE + min(23),
      }),
    },
  },
  {
